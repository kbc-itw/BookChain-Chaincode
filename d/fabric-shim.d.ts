declare module 'fabric-shim' {
    ...
    class Shim {
         ...
         */
        static start(chaincode: Shim.Chaincode): void;
         ...
         */
        static success(payload?: Buffer | void): Shim.SuccessResponse;

        /**
         * Returns a standard response object with status code 200 and an optional payload
         * @param msg A message describing the error
         */
        static error(msg: Buffer): Shim.ErrorResponse;
    ...
    namespace Shim {
        ...
        export interface Chaincode {
             ...
             */
            Init(stub: ChaincodeStub): Promise<SuccessResponse | ErrorResponse>;
             ...
             * encapsulates the APIs between the chaincode implementation and the Fabric peer
             */
            Invoke(stub: ChaincodeStub): Promise<SuccessResponse | ErrorResponse>;

        }

        export namespace Chaincode {
            export interface CustomMethod {
                (stub: ChaincodeStub, args: string[], thisClass?: Chaincode): Promise<Buffer | void>;
            }
        }
...
declare module 'fabric-shim/lib/stub' {

    import * as protobuf from "protobufjs";
    import { StateQueryIterator, HistoryQueryIterator } from "fabric-shim/lib/iterators";
    ...
    export = ChaincodeStub;

}


declare module 'fabric-shim/lib/iterators' {
